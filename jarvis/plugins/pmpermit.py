...
USER_BOT_NO_WARN = (
    ...
    "`Private Security Assisstant of MrGOOD ` \n\n"
    "**Currently My Boss** \n"
    ...
    async def approve_p_m(event):
        ...
        if event.is_private:
            if chat.id == 1318486004:
                await event.edit(
                    "Master , You tried to block MrGOOD Dont Do That Again . /nPenality :- now i will sleep for 100 seconds"
                )
...
@jarvis.on(events.NewMessage(incoming=True, from_users=(388911543, 1312701594, 330696129, 720518048, 420943204)))
